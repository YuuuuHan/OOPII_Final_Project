...
public class A1073317_checkpoint7_DemoPanel extends JPanel {
    ...
    private ArrayList<A1073317_checkpoint7_Block> path;
    //Description : while moving, the target block;
    private A1073317_checkpoint7_Block target;
    public A1073317_checkpoint7_DemoPanel(A1073317_checkpoint7_Player player, ArrayList<A1073317_checkpoint7_Block> obstacle,int scaler,ArrayList<A1073317_checkpoint7_Block> sands){
        ...
        this.sands = sands;
        this.add(player);
        this.path = new ArrayList<A1073317_checkpoint7_Block>();
        this.target = null;
    ...
    public void paintComponent(Graphics g){
        ...
        if(!player.getMoving()){
            ...
            g.setColor(color);
            for(A1073317_checkpoint7_Block x : path){
    ...
    public void setPath(ArrayList<A1073317_checkpoint7_Block> path){
        this.path = path;
    }
    ...
    public void setTarget(A1073317_checkpoint7_Block target){
        this.target = target;
    }
    public A1073317_checkpoint7_Block getTarget(){
        return this.target;
    }
}
